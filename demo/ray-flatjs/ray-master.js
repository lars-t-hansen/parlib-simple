...
function main() {
    ...
    const Par = new MasterPar(new SharedInt32Array(MasterPar.NUMINTS), 0, numWorkers, "ray-worker.js", doneParInit);
	...
	id.data.set(new SharedUint8Array(RAW_MEMORY, _mem_int32[(bits + 4) >> 2], g_width*g_height*4));
